...
public class ReadProp {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream ip = new FileInputStream("C:\\Users\\Madhu X1_Tab\\Downloads\\Compressed\\"
				+ "JuneSeleniumSessions-master\\src\\main\\java\\seleniumsessions\\config.properties");
		prop.load(ip);
